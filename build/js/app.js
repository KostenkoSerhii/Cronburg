...
$(document).ready(function () {
  ...
  var places = [['Частная школа', 55.522763, 37.476325, 'img/school-marker.png'], ['Аптека', 55.525763, 37.468325, 'img/medical-marker.png'], ['Спортзал', 55.524763, 37.473325, 'img/dumbbell-marker.png'], ['Квартал таунхаусов Кронбург', 55.524963, 37.478325, 'img/logo-marker.png']];
